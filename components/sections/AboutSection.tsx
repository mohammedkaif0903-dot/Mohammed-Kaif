...
export default function AboutSection() {
  return (
    <section id="about" className="relative py-24 px-2 sm:px-6 overflow-hidden">
      {/* Background Elements */}
            ...
            <div className="relative glass-strong rounded-3xl p-6 md:p-10 border border-white/10 hover:border-[#00D4FF]/30 transition-colors duration-300">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00D4FF]/20 to-[#7B61FF]/20 flex items-center justify-center border border-[#00D4FF]/30 shadow-[0_0_15px_rgba(0,212,255,0.1)]">
                  <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-[#00D4FF] to-[#7B61FF]">
                    MK
                  </span>
                </div>
                <div>
                  ...
                  <p className="text-lg text-[#00D4FF] font-medium tracking-wide mt-1">
                    Junior QA Engineer
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6 text-white/70 leading-relaxed text-base md:text-lg">
                <p>
                  ...
                  with skills in manual testing, test case design, defect
                  tracking, and cross-functional collaboration. Experienced in
                  testing AI-driven healthcare and logistics applications using
                  QA methodologies like{" "}
                  <span className="text-[#7B61FF]">SDLC, STLC</span>,
                  functional, regression, UI/UX, and negative testing.
                </p>
                <p>
                  Proficient in executing{" "}
                  <span className="text-[#00D4FF]">smoke/sanity tests</span>,
                  reporting bugs, and ensuring product quality across platforms.
                  Seeking to apply a quality-first approach in a fast-paced,
          ...
          <div className="space-y-10 min-w-0">
            ...
            >
              {[
                ...
                <div
                  key={i}
                  className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[#00D4FF]/20 transition-all duration-300 group"
                >
                  <h4 className="text-4xl md:text-5xl font-bold text-white mb-2 group-hover:text-[#00D4FF] transition-colors">
                    {stat.value}
                  </h4>
